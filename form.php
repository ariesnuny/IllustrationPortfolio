...
$email_to = "mutilvanuria7@gmail.com";
...
echo "<b>There has been a mistake and the message wasn't send. </b><br />";
echo "Please check the information<br />";
die();
}
...
echo "The message has been send successfully";
}
?>